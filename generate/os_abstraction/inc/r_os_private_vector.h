...
#define R_OS_ABSTRACTION_CFG_PRV_SVC_HANDLER       (svc_handler) //(vector_swi)				//(FreeRTOS_SWI_Handler)
...
#define R_OS_ABSTRACTION_CFG_PRV_IRQ_HANDLER       (vector_irq)				//(FreeRTOS_IRQ_Handler)
#define R_OS_ABSTRACTION_CFG_PRV_FIQ_HANDLER       (vector_fiq)				//(fiq_handler)
